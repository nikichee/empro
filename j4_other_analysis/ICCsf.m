function out = ICCsf(cse,typ,dat)
...
%
% 'dat' is data whose COLUMNS represent different ratings or raters & whose
% ROWS represent different cases or targets being measured. Each target
...
% https://de.mathworks.com/matlabcentral/fileexchange/21501-intraclass-correlation-coefficients/content/ICC.m
%~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
%%
...
WSS = sum(sum(bsxfun(@minus,dat,mpt).^2)); % same as sum(sum((dat-repmat(mpt,1,size(dat,2))).^2))
