function [allbet, allbet_psc, allbet_mean] = extractbetas_allsubsfromfl_sphere_wmcsf(TR)
...
save(fullfile(datadir, ['parameterestimates_sphere_' [TR zusatz] '.mat']), 'allbet', 'allbet_psc', 'allbet_mean', 'voxelindices', 'mnicoo', 'clusternames');
