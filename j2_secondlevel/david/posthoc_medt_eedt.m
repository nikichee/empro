...
matlabbatch{1}.spm.stats.factorial_design.dir = {'/net/mri.meduniwien.ac.at/projects/physics/fmri/data/empro15/analysis/edt/2_secondlevel/posthoc_ttest_medt_eedt'};
matlabbatch{1}.spm.stats.factorial_design.des.pt.pair(1).scans = {
                                                                  '/z/fmri/data/empro15/analysis/morph/1_firstlevel/fl_2reg/m1/empro15_001/con_0002.nii,1'
                                                                  '/z/fmri/data/empro15/analysis/edt/1_firstlevel/fl_session_s6/m1/1.4/empro15_001/con_0005.nii,1'
                                                                  };
...
for i=2:length(subjects)
  ...
  matlabbatch{1}.spm.stats.factorial_design.des.pt.pair(i).scans = {
                                                                  ['/z/fmri/data/empro15/analysis/morph/1_firstlevel/fl_2reg/m1/' sub '/con_0002.nii,1']
