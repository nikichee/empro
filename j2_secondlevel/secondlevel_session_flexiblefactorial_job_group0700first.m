...
ms = {'m1'};
% ms = {'m1','m2'};
firstleveldir = '/z/fmri/data/empro15/analysis/edt/1_firstlevel/fl_session_s6/';
...
secondleveldir = ['/net/mri.meduniwien.ac.at/projects/physics/fmri/data/empro15/analysis/edt/2_secondlevel/tmp_sl_FIRSTRUN_TR0.7_m1'];%flexiblefactorial_TR' TR '_runs-conds-interact/'];
subs = {
    'empro15_002'    
    'empro15_005'
    'empro15_006'
...
for s=1:size(subs,1)
    ...
    for mi=1:size(ms,2)
        ...
        for t=1:size(TRs,2)
            ...
            betas(bi+1) = {[fullfile(firstleveldir,meas,TR, subs{s}, '/beta_0001.nii') ',1']};
            betas(bi+2) = {[fullfile(firstleveldir,meas,TR, subs{s}, '/beta_0002.nii') ',1']};
            betas(bi+3) = {[fullfile(firstleveldir,meas,TR, subs{s}, '/beta_0003.nii') ',1']};
            betas(bi+4) = {[fullfile(firstleveldir,meas,TR, subs{s}, '/beta_0010.nii') ',1']};
            betas(bi+5) = {[fullfile(firstleveldir,meas,TR, subs{s}, '/beta_0011.nii') ',1']};
            betas(bi+6) = {[fullfile(firstleveldir,meas,TR, subs{s}, '/beta_0012.nii') ',1']};
            betas(bi+7) = {[fullfile(firstleveldir,meas,TR, subs{s}, '/beta_0019.nii') ',1']};
            betas(bi+8) = {[fullfile(firstleveldir,meas,TR, subs{s}, '/beta_0020.nii') ',1']};
            betas(bi+9) = {[fullfile(firstleveldir,meas,TR, subs{s}, '/beta_0021.nii') ',1']};
...
%             end
            if strcmp(subs(s), 'empro15_003') && mi==1 && strcmp(TR, '0.7')
                bi=bi-3 
                betas(7:9)=[]
