...
secondleveldir = ['/net/mri.meduniwien.ac.at/projects/physics/fmri/data/empro15/analysis/edt/2_secondlevel/tmp_sl_FIRSTRUN_TR1.4_m1'];%flexiblefactorial_TR' TR '_runs-conds-interact/'];
subs = {
    'empro15_001'
    'empro15_003'
    'empro15_009'
