...
TRs = {'0.7','1.4'};
subs = {
    'empro15_001', 'empro15_002', 'empro15_003', 'empro15_005', 'empro15_006', 'empro15_007', 'empro15_009', 'empro15_010', 'empro15_011', 'empro15_012','empro15_013', 'empro15_014', 'empro15_015', 'empro15_016', 'empro15_018'
};
...
%             for r=1:3
                ...
                j=1;
                matlabbatch{i}.spm.stats.con.spmmat = {['/net/mri.meduniwien.ac.at/projects/physics/fmri/data/empro15/analysis/edt/1_firstlevel/fl_session_s6_wm_csf/m' num2str(m) '/' TRs{t} '/' subs{s} '/SPM.mat']};
                disp(matlabbatch{i}.spm.stats.con.spmmat);
