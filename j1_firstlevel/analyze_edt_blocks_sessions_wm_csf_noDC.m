...
for s=1:size(measurements_to_analyze,1)
    ...
    for t=1:1
        ...
        analysisdir = ['/z/fmri/data/empro15/analysis/edt/noDC/1_firstlevel/fl_session_s6_wm_csf/' cm '/' num2str(TR) '/' csubj '/'];
...
%         end
        ...
        for r=1:3
            ...
            if exist(fullfile(scanpath, 'tc_wm_csf_rp_iwrbadvols.txt'), 'file') %'tc_wm_csf_global_rp_iwrbuadvols.txt'
                realignmentparameters = load(fullfile(scanpath, 'tc_wm_csf_rp_iwrbadvols.txt')); % 'rbuadvols.nii.par.txt'
