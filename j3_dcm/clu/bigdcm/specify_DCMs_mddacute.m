...
subs = importdata('/z/fmri/data/empro15/analysis/edt/3_dcm/tmp_clu/mdd.all_current.txt');
...
for s=1:length(subs);
    for m=2:2
        for dirs =1:3            
            ...
            VOI_dir = ['/z/fmri/data/clu12/analysis/edt/analysis_spm/fl_preprocv3_wmcsf/m' num2str(m) '/all/' subs{s}]; %% messung korrigieren!!! 
